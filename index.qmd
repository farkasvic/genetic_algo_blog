...
We can see that the initial generation has a pretty low average fitness score, but as the models evolve into each subsequent generation and select for the better 'genes', the average fitness scores steadily increase until the average performance across all models within a generation is pretty much equal to the best performing model.
