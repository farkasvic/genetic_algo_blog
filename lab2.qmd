...
Taylor is an 18-year-old high school student with an interest in studying data science. They've taken all upper year core science and math courses in order to apply for university and is familiar with most fundamentals in biology as well as some basic computing terminology such as 'algorithms' and 'optimization'. They have not explored any data science topics in depth but are interested in learning more to see if that major would suit them.
